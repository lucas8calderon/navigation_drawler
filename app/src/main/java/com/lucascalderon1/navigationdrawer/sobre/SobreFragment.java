package com.lucascalderon1.navigationdrawer.sobre;
...
import com.lucascalderon1.navigationdrawer.R;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("lucas.calderon.925", "Facebook")
                .addInstagram("lucas8calderon", "Instagram")
                .addTwitter("lucas.calderon.925", "Twitter")
                .addYoutube("UC8xkIu_ja5mcAA7tf5sQoAA", "YouTube")
                .addGitHub("lucas8calderon", "GitHub")
                .addPlayStore("com.google.android.apps.plus", "Download App")

                .addGroup("Entre em contato")
                .addEmail("atendimento@atmconsultoria.com.br", "Envie um e-mail")
                .addWebsite("https://www.linkedin.com/in/lucas-calderon-9b2a941a6/", "Acesse nosso linkdin")
